                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            {{-- <img class="direct-chat-img" src="../../dist/assets/img/user1-128x128.jpg"
                                                ...
                                                <img class="direct-chat-img" src="{{ asset('assets/assets/img/user1-128x128.jpg') }}" alt="message user image" />
                                        ...
                                        <div class="direct-chat-msg end">
                                            ...
                                            {{-- <img class="direct-chat-img" src="../../dist/assets/img/user3-128x128.jpg"
                                                alt="message user image" /> --}}
                                                <img class="direct-chat-img" src="{{asset('\assets\assets\img/user3-128x128.jpg')}}"
                                                alt="message user image" />
                                            <!-- /.direct-chat-img -->
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            {{-- <img class="direct-chat-img" src="../../dist/assets/img/user1-128x128.jpg"
                                                alt="message user image" /> --}}
                                                <img class="direct-chat-img" src="{{asset('\assets\assets\img/user1-128x128.jpg')}}"
                                                alt="message user image" />
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
